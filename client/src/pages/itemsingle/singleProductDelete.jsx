...
export default function SingleProductDelete() {
    const handleChange = (e) => {
      ...
      const handleSubmit = (e) => {
        ...
        axios.post(`http://localhost:5005/api/items/deleteProd/${id}`)
          .then((response) => {
            setDeleteProd(false);
                ...
                <div className="container-fluid pt-4 px-4">
                    <div className="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                        ...
                        <div class="modal-content">
							<div action="/delete/<%= donation._id %>" method="POST">
								<div class="modal-header">						
									<h4 class="modal-title">Delete Donation Data</h4>
