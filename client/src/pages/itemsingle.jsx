      ...
      <div>
        ...
        <div className="col-lg-6 mb-5 ftco-animate">
    		<a href="" className="image-popup prod-img-bg"><img src={singleProduct.productImage} className="img-fluid" alt="Colorlib Template" /></a>
          	...
          	<p><a href="/singleProductEdit/:id" className="btn btn-black py-3 px-5 mr-2">Edit Product</a><a href="/delete" className="btn btn-primary py-3 px-5">Delete Product</a></p>
    			</div>
    		</div>
